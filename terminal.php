...
border-radius: 16px;
position: relative;
box-shadow: -10px -10px 20px white,10px 10px 16px rgba(60,60,60,.4),
inset -10px -10px 8px -7px rgba(60,60,60,.3),inset 10px 10px 10px -5px white;
}
.screen{
...
display: block;
height: 16px;
box-shadow: -3px -3px 5px white,3px 3px 5px rgba(60,60,60,.6),
inset 2px 2px 5px white,inset -2px -2px 3px rgba(60,60,60,.6);
width: 16px;
border-radius: 30px;
...
transition: 0.4s;
box-shadow: inset -10px -10px 10px -5px white,inset 10px 10px 10px -5px rgba(60,60,60,.3);
}
.text:hover{
position: absolute;
bottom: 3px;
...
box-shadow: -3px -3px 5px white,3px 3px 5px rgba(60,60,60,.6),
inset 2px 2px 5px -1px white,inset -2px -2px 3px -1px rgba(60,60,60,.6);
...
<div class="out2"><font color="#333" size="2">
<?php echo $adinfo; ?>
<!--
<br>
key:<br>
...
<div class="out"><div class='ast'><font color="#333" size="2">
<?php
if (isset($_POST['scsi'])){
$com = $_POST['com0'];
session_start();
